(() => {
  ...
  let nombre: string; // La variable 'nombre' se declara, pero no se le asigna ningún valor
  console.log(nombre); // Imprime 'undefined'

  /*  null  */
  let persona: { nombre: string; edad: number } | null = null; // La variable 'persona' se inicializa con 'null'
